...
export const metadata: Metadata = {
  ...
  description:
    "Join our mission: donate, sponsor components, or partner to expand mobility in Kenya.",
};
      ...
      <section className="mt-6 grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { src: "/sample-3rdwheel.png", alt: "Front module detail" },
              {
                ...
                alt: "Young woman in wheelchair by the water",
              },
            ].map((i) => (
              <div
                key={i.src}
                className="relative rounded-lg overflow-hidden border border-black/10 dark:border-white/15 h-56"
              >
                <Image
                  src={i.src}
                  alt={i.alt}
        ...
        <div className="space-y-5">
          <h2 className="text-xl font-medium">
            Back bold ideas that move people
          </h2>
          <p className="text-black/75 dark:text-white/75">
            Your contribution accelerates independence — from recycled battery
            packs to local manufacturing and user-centered testing.
          </p>
          <div className="grid gap-3">
            <div className="rounded-lg border border-black/10 dark:border-white/15 p-4">
              <div className="font-medium">Donate</div>
              <div className="text-sm text-black/70 dark:text-white/70">
                Make a tax-deductible contribution to power the next production
                run.
              </div>
            </div>
            <div className="rounded-lg border border-black/10 dark:border-white/15 p-4">
              ...
              <div className="text-sm text-black/70 dark:text-white/70">
                Fund key parts — batteries, controllers, clamps — and help scale
                responsibly.
              </div>
            </div>
            <div className="rounded-lg border border-black/10 dark:border-white/15 p-4">
              ...
              <div className="text-sm text-black/70 dark:text-white/70">
                Manufacturers, distributors, and community orgs: let’s build
                mobility access together.
              </div>
            </div>
          </div>
